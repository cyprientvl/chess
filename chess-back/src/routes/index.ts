...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/book-collections/:id',
            authenticateMiddleware([{"jwt":["user:read"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController)),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController.prototype.getBooksCollection)),

            async function BookCollectionController_getBooksCollection(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
        ...
        app.post('/book-collections',
            authenticateMiddleware([{"jwt":["user:write"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController)),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController.prototype.createBook)),

            async function BookCollectionController_createBook(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    body: {"in":"body","name":"body","required":true,"ref":"CreateBookCollectionBody"},
            };
        ...
        app.patch('/book-collections/:id',
            authenticateMiddleware([{"jwt":["user:write"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController)),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController.prototype.updateBook)),

            async function BookCollectionController_updateBook(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
                    b: {"in":"body","name":"b","required":true,"ref":"BookCollectionDTO"},
            };
        ...
        app.delete('/book-collections/:id',
            ...
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController)),
            ...(fetchMiddlewares<RequestHandler>(BookCollectionController.prototype.deleteBookCollections)),

            async function BookCollectionController_deleteBookCollections(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'deleteBookCollections',
                controller,
                response,
                next,
                validatedArgs,
        ...
        app.post('/books',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"CreateBookBody"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/books/:id/booksCollections',
            authenticateMiddleware([{"jwt":["user:read"]}]),
            ...(fetchMiddlewares<RequestHandler>(BookController)),
            ...(fetchMiddlewares<RequestHandler>(BookController.prototype.getBookInBooksCollection)),

            async function BookController_getBookInBooksCollection(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'getBookInBooksCollection',
                controller,
                response,
                next,
                validatedArgs,
